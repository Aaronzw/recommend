...
public class ChinaMovie {
	...
	public static void main(String args[]) throws InterruptedException, ExecutionException {
		...
		Vector <String> nameOfMovieIntxt = getStringFromTxt.GetStringFromTxToVector("D://课程设计//电影天堂//中国电影//AllMovie.txt");
		...
		for (int i = 0; i < 5; i++) {
			String url = "http://www.ygdy8.net/html/gndy/china/list_4_" + 
					 String.valueOf(i + 1) + ".html";
			newmovie[i] = new GetMovieByUrl(url, 1);
		}
		...
		for (int i = 0; i < allMovie.size(); i++) {
			...
			thread.addElement(new Thread(new downLoadPhoto(allMovie.get(i), "D://课程设计//电影天堂//中国电影")));
