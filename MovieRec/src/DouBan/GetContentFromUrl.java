...
public class GetContentFromUrl {
	private static final Logger Log = Logger.getLogger(GetContentFromUrl.class.getName());
	 ...
	 * @return
	 */
	public UrlAndContent getContentFromUrl(String url){
		String content = null;
		String type = null;
		int statusCode = 500;
		...
		UrlAndContent fetchedPage = null; 
		if(type.equalsIgnoreCase("html")){
			fetchedPage= new UrlAndContent(url, content, statusCode,CrawlerParams.FETCHEDPAGETYPE_HTML);
		}else if(type.equalsIgnoreCase("json")){
			fetchedPage = new UrlAndContent(url, content, statusCode,CrawlerParams.FETCHEDPAGETYPE_JSON);
		}
		return fetchedPage;
	}
}
